...
type Props = {
  open: boolean
  onClose: () => void
  item: StockDirectSaleWithVariety | null
...
export default function VenteSlideOver({
  open,
  onClose,
  item,
  ...
  // Stock disponible pour la combinaison selectionnee
  ...
  const stockInsuffisant = stockDispo !== null && poidsNum > stockDispo

  const titleLabel = isEdit ? 'Modifier la vente' : 'Nouvelle vente directe'
          ...
          <div className="px-6 py-5 space-y-5 flex-1">
            ...
            <Field label="Destinataire">
              <input
                name="destinataire"
                type="text"
                defaultValue={item?.destinataire ?? ''}
                disabled={isPending}
