...
export type Database = {
  public: {
    Tables: {
      ...
      // ──────────────────────────────────────────────────────────────
      // 3b. BOUTURES — multiplications végétatives (migration 040)
      // ──────────────────────────────────────────────────────────────
      ...
      boutures: {
        Row: {
          ...
          uuid_client: string | null
          variety_id: string | null
          type_multiplication: 'rhizome' | 'bouture' | 'marcotte' | 'eclat_pied' | 'drageon' | 'eclat_racine'
          origine: string | null
          certif_ab: boolean
          statut: 'bouture' | 'repiquage' | 'pret' | 'en_plantation' | 'epuise'
