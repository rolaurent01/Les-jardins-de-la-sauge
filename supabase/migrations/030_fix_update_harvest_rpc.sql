-- 030 : Corrige update_harvest_with_stock
-- La colonne updated_by n'existe pas sur stock_movements (migration 011 : immutables).
-- Le RPC plantait avec "column updated_by does not exist" → erreur generique cote UI.
